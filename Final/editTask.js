    ...
    window.addEventListener('load', function () {
      ...
      Array.prototype.filter.call(forms, function (form) {
        form.addEventListener('submit', function (event) {
          ...
          window.location.href="weekView.html?class="+ Class + "&&defaultTime="+ defaultTime +"&&title="+event.title+"&&location="+event.location+"&&date="+event.date+"&&start_date="+event.start_date+"&&start_hour="+event.start_hour+"&&start_ampm="+event.start_ampm+"&&start_min="+event.start_min+
